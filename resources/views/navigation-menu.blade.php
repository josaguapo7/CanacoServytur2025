            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('imagenes/canaco.png') }}" class="h-12 w-auto" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('admin')
                        ...
                        <x-nav-link href="{{ route('admin.socios') }}" :active="request()->routeIs('admin.socios')">
                            Administrar Socios
                        </x-nav-link>
                    @endcan

                    <!-- Opción "Subir Documento" -->
                    <x-nav-link href="{{ route('upload.form') }}" :active="request()->routeIs('upload.form')">
                        Subir Documento
                    </x-nav-link>

                    <!-- Opción "Mis Documentos" -->
