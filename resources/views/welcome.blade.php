    ...
    <div class="grid md:grid-cols-2 gap-8 items-start">
      <div class="bg-gray-50 rounded-lg p-6">
        ...
        <div class="space-y-4">
          ...
          <button
            type="button"
            class="w-full text-sm bg-blue-700 hover:bg-blue-900 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
          >
            Enviar
          </button>
        </div>
      ...
      <div class="space-y-8">
        <div class="bg-white rounded-lg p-6 shadow">
          <h3 class="text-xl font-semibold text-indigo-900 mb-6">Informacion de Contacto</h3>
          ...
          <div class="space-y-4">
            <div class="flex items-start space-x-3">
              ...
              <div>
                <h4 class="font-semibold text-gray-900 text-sm mb-1">Nuestra ubicacion</h4>
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                <h4 class="font-semibold text-gray-900 text-sm mb-1">Telefono</h4>
        ...
        <div class="bg-white rounded-lg p-6 shadow">
          <h3 class="text-xl font-semibold text-indigo-900 mb-6">Horario de Atencion</h3>
          <div class="space-y-4">
            ...
            <div class="flex justify-between">
              <span class="text-gray-600 text-sm">Sabado</span>
