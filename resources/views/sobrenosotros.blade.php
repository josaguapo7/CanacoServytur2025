...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <a href="home" class="flex items-center space-x-8 rtl:space-x-reverse">
...
{{--<div class="bg-gradient-to-r from-blue-900 to-cyan-700 min-h-screen flex  p-8">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-6xl">
        
        <!-- Sección de Imagen -->
        <div class="w-full">
            <img src="{{ asset('imagenes/curso.png') }}" alt="" class="rounded-lg shadow-lg w-full h-full object-cover">
        </div>

        <!-- Sección de Facebook -->
        <div class="bg-white shadow-lg rounded-lg p-6 text-center">
            <h2 class="text-lg font-bold mb-4">Universidad Tecnológica de la Selva</h2>
            <div class="fb-page" 
                 data-href="https://www.facebook.com/CANACOSCLC" 
                 data-tabs="timeline" 
                 data-width="400" 
                 data-height="600" 
            ...
            <script async defer crossorigin="anonymous" 
                src="https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v12.0" nonce="ABC123">
            </script>
        </div>  
