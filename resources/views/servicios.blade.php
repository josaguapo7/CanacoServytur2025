...
<body class="bg-gray-100 flex mt-10 items-center justify-center min-h-screen">
    <div class="container mx-auto flex items-center justify-center min-h-screen">
        <div class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
            <h2 class="text-2xl font-semibold text-center text-blue-900 mb-6">Pago Seguro</h2>
            
            <form action="/procesar-pago" method="POST" class="space-y-4">
                <div>
                    <label class="block text-blue-900 font-medium">Nombre en la Tarjeta</label>
                    <input type="text" name="nombre" required class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900">
                </div>
                
                <div>
                    <label class="block text-blue-900 font-medium">Número de Tarjeta</label>
                    <input type="text" name="numero" required maxlength="16" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900">
                </div>
                
                <div class="flex space-x-4">
                    <div class="w-1/2">
                        <label class="block text-blue-900 font-medium">Fecha de Expiración</label>
                        <input type="text" name="expiracion" required placeholder="MM/AA" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900">
                    </div>
                    
                    <div class="w-1/2">
                        <label class="block text-blue-900 font-medium">CVV</label>
                        <input type="text" name="cvv" required maxlength="3" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900">
                    </div>
                </div>
                
                <div class="bg-blue-900 text-white p-4 rounded-lg text-center">
                    <p class="text-lg font-semibold">Total: $1850.00 MXN</p>
                </div>
                
                <button type="submit" class="w-full bg-blue-900 text-white p-3 rounded-lg font-semibold hover:bg-blue-800 transition">Pagar Ahora</button>
            </form>
        </div>
    </div>
</body>
